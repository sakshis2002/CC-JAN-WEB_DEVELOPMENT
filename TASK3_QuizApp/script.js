var questions = [
    {
        ...
        options: [
            "Mahatma Gandhi", "Jawaharlal Nehru", "Rajendra Prasad", "Kejariwal"
        ]
    },
    {
        ...
        options: [
            "Narendra Modi", "Dr. Rajendra Prasad", "Pratibhatai Patil", "Sushilkumar Shinde"
        ]
    },
    {
    ...
    },
    {
        ...
        options: [
            "Savitribai Phule", "Lata Mangeshkar", "Sindhutai Sapkal", "P.V.Sindhu"
        ]
    },
    {
        ...
        options: [
            "P.T. Usha", "Sakshi Mallik", "Karnam Malleswari", "Sania Mirza"
        ]
    },
]
questions_temp =
...
function appendResult() {
    ...
    for (var i = 0; i < questions.length; i++) {
        if (answers[i]) {
            divBody += "<td><img style='width:30px' src='correct.jpg'></td>"
            correctQuestions++
        }
        else divBody += "<td><img style='width:30px' src='002.jpg'></td>"
    }
    divBody += "</tbody></table>"
...
function loginButton() {
    ...
    if (username.value === "ab_c" && password.value === "abc") {
